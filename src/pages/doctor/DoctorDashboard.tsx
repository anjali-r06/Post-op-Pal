...
import { Stethoscope, Clock, MessageSquare, Calendar, TrendingUp, Users, Activity, AlertTriangle } from 'lucide-react'

const DoctorDashboard: React.FC = () => {
  const { user } = useAuth()

  const stats = [
    { label: 'Total Patients', value: '24', change: '+2', icon: Users },
    { label: 'Active Cases', value: '18', change: '+1', icon: Activity },
    { label: 'Alerts', value: '3', change: '-1', icon: AlertTriangle },
    { label: 'Appointments Today', value: '8', change: '+0', icon: Calendar },
  ]
